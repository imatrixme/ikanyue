...
The system SHALL render visible, metadata-driven pet motion during normal use using normalized frame animation with expanded action loops, stable frame alignment, and support for selected V5 source-rendered frame assets.
