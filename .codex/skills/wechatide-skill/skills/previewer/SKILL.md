...
上传代码包 / 发布体验版。**仅在用户明确要求「上传」、「上传代码」、「发布体验版」时调用。**

对应 `tools.yaml` 中的 `upload`。

```bash
wechatide -c <clientName> -t upload --project <project> --upload-version 1.0.0 [--desc "备注"]
```
